...
def main():
    ...
    reg = [
        entry("DHESI_V3", "dhesi_inversion", "PREREGISTERED",
              "Canonical spec + protocol V1 + amendment 1 frozen; PR #1 merged a1486c4; binding V2 36ae3bc1...; awaiting owner Sierra harvest, then integrity -> VALIDATION_READY",
        ...
        entry("TRIDENT_V2", "ext8_trident", "DEVELOPMENT",
              "V2 source spec frozen (manifest 00763a96...) but Agent 2 audit FAIL: unsupported C7 gate; must fix + re-freeze before DEV PnL",
              "agent1", spec="V2_PREREG_MANIFEST aggregate 00763a9620f98f8e191904311deba37a24661476a2c996de2e1d7ec1b5241a98"),
        entry("MMXM_V2", "ext8_mmxm_ote", "PREREGISTERED",
              "V2 source spec audit PASS (Agent 2, 1c9228b); DEV run pending; sealed FX/XAU 2025-01..2026-08 unread",
              "agent1", spec="V2_PREREG_MANIFEST aggregate 00763a9620f98f8e191904311deba37a24661476a2c996de2e1d7ec1b5241a98"),
        entry("FOMO_PROSPECTIVE", "fomo", "VALIDATING",
              "Prospective recorder; evaluate once at >=3,500 eligible trades and >=14 days, or 45 days (FOMO_PROSPECTIVE_PREREGISTRATION.md 902263424c170fb7...)",
              "agent1"),
    ...
    plan = {"manifest": "SIERRA_ASSET_MANIFEST_V2", "status": "PLAN (metadata only; nothing harvested yet)", "as_of": TODAY,
            ...
            "assets": [
                {"priority": 1, "instrument": "NQ continuous (volume roll, no back-adjust)", "resolution": "1 minute",
                 "range": "earliest available (~2009-11, 15-y intraday limit) -> 2024-10-31", "est_disk": "0.3-0.7 GB",
